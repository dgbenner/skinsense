# AI Skincare Recognition Prototype
...
- `/docs` — research notes and test data  
- `main.ipynb` — notebook for running recognition models

### Usage
1. Open the notebook or prototype interface.  
2. Upload or capture an image of a product or shelf.  
3. View predicted product classifications and suggested matches.  
